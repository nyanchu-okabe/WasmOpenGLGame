...
(() => {
  // Create a small, never-async wrapper around createGameDemo which
  // checks for callers incorrectly using it with `new`.
  var real_createGameDemo = createGameDemo;
  createGameDemo = function(arg) {
    if (new.target) throw new Error("createGameDemo() should not be called with `new createGameDemo()`");
    return real_createGameDemo(arg);
  }
})();
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = createGameDemo;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = createGameDemo;
} else if (typeof define === 'function' && define['amd'])
  define([], () => createGameDemo);
